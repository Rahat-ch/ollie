...
- Evidence Integrity **1.00 over 2,331 citations** (1,502 tuning, 829 held out), 95% CI **0.998 to 1.000**: every Problem ID cited by every Notes written, rejected attempts included, exists and agrees with its claim. The one number here large enough to be tight.
