...
function formatCounts(packages) {
  return licenceCounts(packages)
...
function renderGeneratedSection(packages) {
  ...
  const lines = [
    ...
    "",
    `Licence counts: ${formatCounts(packages)}. Last audited ${new Date().toISOString().slice(0, 10)}.`,
    "",
  ];
