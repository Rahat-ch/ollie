...
<!-- BEGIN:deps -->
Generated by `node scripts/third-party.mjs --write` from `pnpm licenses list --json --long`: 366 packages (dependencies, devDependencies, and optionalDependencies). Do not edit by hand.

Licence counts: MIT 313, Apache-2.0 22, ISC 14, BSD-2-Clause 7, MPL-2.0 3, BSD-3-Clause 2, 0BSD 1, BlueOak-1.0.0 1, CC-BY-4.0 1, CC0-1.0 1, Python-2.0 1. Last audited 2026-09-10.
