...
export { checkEvidence, claimPolarity, namesWeakness, namesWeaknessAsDifficulty, scoreHypotheses, WEAKNESS_TAGS } from "./hypotheses";
...
export type { LearnerRescore, NamingScores } from "./rescore";
export { formatRescore, rescoreReport, scoreNaming } from "./rescore";
