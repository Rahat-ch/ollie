...
/** `puppies/result-unknown/add-to/7+5=12` */
export function poolKey({ theme, skill, structure, equation }: PoolInput): string {
  return `${theme}/${skill}/${structure}/${equation.left}${equation.op}${equation.right}=${equation.result}`;
}
