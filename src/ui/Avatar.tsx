...
export function Avatar({ color, worn = NOTHING_WORN, size = 72, label = "Your Avatar" }: AvatarProps) {
  ...
  return (
    ...
    >
       ...
       * tall and tufted, so the two never read as the same character. The
      ...
      <circle cx="30" cy="41" r="7.5" className="fill-paper" />
      <circle cx="30" cy="41" r="4.4" className="fill-teal" />
      <circle cx="30" cy="41" r="2.6" className="fill-ink" />
      <circle cx="28.4" cy="39.4" r="1.5" className="fill-paper" />
      <circle cx="50" cy="41" r="7.5" className="fill-paper" />
      <circle cx="50" cy="41" r="4.4" className="fill-teal" />
      <circle cx="50" cy="41" r="2.6" className="fill-ink" />
      <circle cx="48.4" cy="39.4" r="1.5" className="fill-paper" />
